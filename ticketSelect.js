const tableBody = document.querySelector("#biletler tbody");
const data3 = [];
...
function showFilm() {
    ...
    data3.forEach(item => {
        ...
        <tr class="border-b bg-[#373737] text-white  border-[#d9dadb] fira-sans-medium  transition" >
            ...
            <td class="py-4 px-2 max-sm:p-1 text-center"><img alt="flag" loading="lazy" width="24" height="24" decoding="async" data-nimg="1" src="img/flag1.svg" style="color: transparent;"></td>
